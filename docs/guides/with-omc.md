# Using Forgen with oh-my-claudecode

Forgen and [oh-my-claudecode](https://github.com/Yeachan-Heo/oh-my-claudecode) (OMC) serve different purposes and can complement each other.

## What Each Does

| Aspect | oh-my-claudecode | forgen |
|--------|-----------------|--------|
...
At `npm install` time, forgen's postinstall script detects OMC by checking for `~/.omc`. When detected:
...
**Forgen alone**: You want a lightweight harness (3 deps) that learns your coding style over time. Great for individual developers who work on the same codebase regularly.

**Both together**: Experimental. You want OMC's orchestration AND forgen's learning loop. Expect rough edges.

## Key Difference

OMC asks: "How can AI tools be more powerful?"
Forgen asks: "How can AI tools understand ME better?"
