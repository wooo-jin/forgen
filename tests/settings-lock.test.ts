...
const mocks = vi.hoisted(() => {
  const tmpDir = '/tmp/forgen-settings-lock-test-' + process.pid;
  return {
    CLAUDE_DIR: tmpDir,
...
vi.mock('../src/core/paths.js', () => ({
  ...
  COMPOUND_HOME: '/tmp/forgen-compound-test-' + process.pid,
  ME_DIR: '/tmp/forgen-compound-test-' + process.pid + '/me',
  ME_PHILOSOPHY: '/tmp/forgen-compound-test-' + process.pid + '/me/philosophy.json',
  ME_SOLUTIONS: '/tmp/forgen-compound-test-' + process.pid + '/me/solutions',
  ME_BEHAVIOR: '/tmp/forgen-compound-test-' + process.pid + '/me/behavior',
  ME_RULES: '/tmp/forgen-compound-test-' + process.pid + '/me/rules',
  PACKS_DIR: '/tmp/forgen-compound-test-' + process.pid + '/packs',
  STATE_DIR: '/tmp/forgen-compound-test-' + process.pid + '/state',
  SESSIONS_DIR: '/tmp/forgen-compound-test-' + process.pid + '/sessions',
  GLOBAL_CONFIG: '/tmp/forgen-compound-test-' + process.pid + '/config.json',
  LAB_DIR: '/tmp/forgen-compound-test-' + process.pid + '/lab',
  LAB_EVENTS: '/tmp/forgen-compound-test-' + process.pid + '/lab/events.jsonl',
  FORGE_PROFILE: '/tmp/forgen-compound-test-' + process.pid + '/me/forge-profile.json',
