#!/bin/bash
# forgen v4.1 — 호스트에서 실제 Claude 호출 검증
...
echo ""
echo "═══════════════════════════════════════════════════"
echo "  forgen v4.1 — Live Claude Host Verification"
echo "═══════════════════════════════════════════════════"
echo ""
...
RESULT=$(claude -p "Run 'echo FORGEN_V41_LIVE' using the Bash tool" --allowedTools Bash 2>&1 || true)
if echo "$RESULT" | grep -q "FORGEN_V41_LIVE"; then
