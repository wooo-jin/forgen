...
Send a report to **security@forgen.dev** with:
...
- The `forgen` CLI tool and its core libraries
...
- Third-party tools invoked by forgen (Claude Code, Codex, Gemini)
- Issues in user-authored skills
- Social engineering attacks

## Security Design Notes

forgen runs 16 shell hooks on Claude Code lifecycle events. Security measures:
